...
fn generate_mobile_web_fixture(
    ...
    let corpus = mobile_web_fixture_corpus(&root.to_string(), bytes as u64, &range_cases);
...
fn mobile_web_fixture_corpus(root: &str, bytes: u64, cases: &[FixtureRangeCase]) -> String {
